            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              ...
              {step === 3 && (
                <div className="text-center py-8">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-2">Thank You for Your Order!</h2>
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg mb-8">
                    ...
                    <div className="mb-2 flex justify-between">
                      ...
                      <span className="text-gray-900 font-medium">ORD-{Math.floor(Math.random() * 900000) + 100000}</span>
                    </div>
